...
var homePositions = {
  ...
  DFy: homeBackLine,
  DMy: homeBackLine + (homeFrontBackGap * 0.25),
  CMy: homeBackLine + (homeFrontBackGap * 0.5),
  AMy: homeBackLine + (homeFrontBackGap * 0.75),
  STy: homeFrontLine
};
...
var awayPositions = {
  ...
  DFy: awayBackLine,
  DMy: awayBackLine - (awayFrontBackGap * 0.25),
  CMy: awayBackLine - (awayFrontBackGap * 0.5),
  AMy: awayBackLine - (awayFrontBackGap * 0.75),
  STy: awayFrontLine
};
...
var FORMATIONS = {
  ...
  THREE_THREE_ONE_THREE: {
    ...
    home: [
      {x: homePositions.CCx, y: homePositions.GKy, number: 1, id: 0},
      {x: homePositions.RWx, y: homePositions.DMy, number: 2, id: 1},
      {x: homePositions.LWx, y: homePositions.DMy, number: 3, id: 2},
      {x: homePositions.RCx, y: homePositions.DFy, number: 4, id: 3},
      {x: homePositions.LCx, y: homePositions.DFy, number: 5, id: 4},
      {x: homePositions.CCx, y: homePositions.DFy, number: 6, id: 5},
      {x: homePositions.RWx, y: homePositions.AMy, number: 7, id: 6},
      {x: homePositions.CCx, y: homePositions.DMy, number: 8, id: 7},
      {x: homePositions.CCx, y: homePositions.STy, number: 9, id: 8},
      {x: homePositions.CCx, y: homePositions.AMy, number: 10, id: 9},
      {x: homePositions.LWx, y: homePositions.AMy, number: 11, id: 10}
    ],
    away: [
      {x: awayPositions.CCx, y: awayPositions.GKy, number: 1, id: 0},
      {x: awayPositions.RWx, y: awayPositions.DMy, number: 2, id: 1},
      {x: awayPositions.LWx, y: awayPositions.DMy, number: 3, id: 2},
      {x: awayPositions.RCx, y: awayPositions.DFy, number: 4, id: 3},
      {x: awayPositions.LCx, y: awayPositions.DFy, number: 5, id: 4},
      {x: awayPositions.CCx, y: awayPositions.DFy, number: 6, id: 5},
      {x: awayPositions.RWx, y: awayPositions.AMy, number: 7, id: 6},
      {x: awayPositions.CCx, y: awayPositions.DMy, number: 8, id: 7},
      {x: awayPositions.CCx, y: awayPositions.STy, number: 9, id: 8},
      {x: awayPositions.CCx, y: awayPositions.AMy, number: 10, id: 9},
      {x: awayPositions.LWx, y: awayPositions.AMy, number: 11, id: 10}
    ]
  ...
  TWO_THREE_FIVE: {
    ...
    home: [
      {x: homePositions.CCx, y: homePositions.GKy, number: 1, id: 0},
      {x: homePositions.RCx, y: homePositions.DFy, number: 2, id: 1},
      {x: homePositions.LCx, y: homePositions.DFy, number: 3, id: 2},
      {x: homePositions.RCx, y: homePositions.CMy, number: 4, id: 3},
      {x: homePositions.CCx, y: homePositions.CMy, number: 5, id: 4},
      {x: homePositions.LCx, y: homePositions.CMy, number: 6, id: 5},
      {x: homePositions.RWx, y: homePositions.STy, number: 7, id: 6},
      {x: homePositions.RCx, y: homePositions.STy, number: 8, id: 7},
      {x: homePositions.CCx, y: homePositions.STy, number: 9, id: 8},
      {x: homePositions.LCx, y: homePositions.STy, number: 10, id: 9},
      {x: homePositions.LWx, y: homePositions.STy, number: 11, id: 10}
    ],
    away: [
      {x: awayPositions.CCx, y: awayPositions.GKy, number: 1, id: 0},
      {x: awayPositions.RCx, y: awayPositions.DFy, number: 2, id: 1},
      {x: awayPositions.LCx, y: awayPositions.DFy, number: 3, id: 2},
      {x: awayPositions.RCx, y: awayPositions.CMy, number: 4, id: 3},
      {x: awayPositions.CCx, y: awayPositions.CMy, number: 5, id: 4},
      {x: awayPositions.LCx, y: awayPositions.CMy, number: 6, id: 5},
      {x: awayPositions.RWx, y: awayPositions.STy, number: 7, id: 6},
      {x: awayPositions.RCx, y: awayPositions.STy, number: 8, id: 7},
      {x: awayPositions.CCx, y: awayPositions.STy, number: 9, id: 8},
      {x: awayPositions.LCx, y: awayPositions.STy, number: 10, id: 9},
      {x: awayPositions.LWx, y: awayPositions.STy, number: 11, id: 10}
    ]
  },
  W_M: {
    name: "W-M",
    home: [
      ...
      {x: homePositions.RWx, y: homePositions.DFy, number: 2, id: 1},
      {x: homePositions.LWx, y: homePositions.DFy, number: 3, id: 2},
      {x: homePositions.RCx, y: homePositions.DMy, number: 4, id: 3},
      {x: homePositions.CCx, y: homePositions.DFy, number: 5, id: 4},
      {x: homePositions.LCx, y: homePositions.DMy, number: 6, id: 5},
      {x: homePositions.RWx, y: homePositions.STy, number: 7, id: 6},
      {x: homePositions.RCx, y: homePositions.AMy, number: 8, id: 7},
      {x: homePositions.CCx, y: homePositions.STy, number: 9, id: 8},
      {x: homePositions.LCx, y: homePositions.AMy, number: 10, id: 9},
      {x: homePositions.LWx, y: homePositions.STy, number: 11, id: 10}
    ],
    away: [
      {x: awayPositions.CCx, y: awayPositions.GKy, number: 1, id: 0},
      {x: awayPositions.RWx, y: awayPositions.DFy, number: 2, id: 1},
      {x: awayPositions.LWx, y: awayPositions.DFy, number: 3, id: 2},
      {x: awayPositions.RCx, y: awayPositions.DMy, number: 4, id: 3},
      {x: awayPositions.CCx, y: awayPositions.DFy, number: 5, id: 4},
      {x: awayPositions.LCx, y: awayPositions.DMy, number: 6, id: 5},
      {x: awayPositions.RWx, y: awayPositions.STy, number: 7, id: 6},
      {x: awayPositions.RCx, y: awayPositions.AMy, number: 8, id: 7},
      {x: awayPositions.CCx, y: awayPositions.STy, number: 9, id: 8},
      {x: awayPositions.LCx, y: awayPositions.AMy, number: 10, id: 9},
      {x: awayPositions.LWx, y: awayPositions.STy, number: 11, id: 10}
    ]
  }
};
